...
Compatible with any coding agent that supports skills. For agents that read from `.agents/skills/` (like [AI Agent](https://docs.anthropic.com/en/docs/claude-code) and [OpenCode](https://github.com/nicepkg/OpenCode)), just drop it in and go.
...
Clone or download this repo, then copy it into your project's `.agents/skills/` directory:
